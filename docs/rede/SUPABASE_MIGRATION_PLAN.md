...
- Extrair o schema atual de verdade do Supabase remoto agora (dump de schema, `information_schema`/`\d+` de cada tabela relevante, ou `supabase db dump`/`supabase gen types` rodado _hoje_, não reaproveitando o snapshot antigo).
